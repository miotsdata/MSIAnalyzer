...
counts, a feature-overlap UpSet plot, and the MS2 association /
``n_features_in_window`` / precursor-purity distributions. It only reads —
the analysis and raw databases are never modified.
"""
